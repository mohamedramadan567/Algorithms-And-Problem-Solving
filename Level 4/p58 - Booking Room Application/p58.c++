...
stPeriod DatePassyRoom()
{
    stPeriod PeriodOfRoom;
    PeriodOfRoom.StartDate.Day = 1;
    PeriodOfRoom.StartDate.Month = 10;
    PeriodOfRoom.StartDate.Year = 2024;

    PeriodOfRoom.EndDate.Day = 25;
    PeriodOfRoom.EndDate.Month = 10;
    PeriodOfRoom.EndDate.Year = 2024;
...
int main()
{
    ...
    Period1 = DatePassyRoom();

    cout << "\nEnter Period of booking room:\n";
    Period2 = ReadPeriod();
    
    if(IsPeriodsOverLap(Period1, Period2))
    cout << "\nSorry, Room is NOT available\n";
    else
    cout << "\nRoom is available you can booking\n";
